...
sysbp_hgram <- fram |>
  ...
  geom_histogram(fill="#ee6677", color="#ee6677", binwidth=5, alpha=0.8) + 
  theme_minimal()
...
ggplot(fram, aes(x=BMI, y=SYSBP) ) +
  stat_density_2d(aes(fill = after_stat(level)), geom = "polygon", colour="white", alpha=0.5) + 
...
ggMarginal(
  bmi_sysbp_plot,
  type="histogram",
  xparams=list(colour="#228833", fill="#228833", alpha=0.7),
  yparams=list(colour="#ee6677", fill="#ee6677", alpha=0.7)
)
