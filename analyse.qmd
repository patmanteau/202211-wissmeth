...
ggplot(rbind(bootstrap1, bootstrap2), aes(x=BMI)) + 
  geom_histogram(data = bootstrap1, fill = "#4477aa", colour = "#4477aa", alpha = 0.8, binwidth = 0.01) + 
  geom_histogram(data = bootstrap2, fill = "#ee6677", colour = "#ee6677", alpha = 0.8, binwidth = 0.01) +
  theme_minimal()
```
