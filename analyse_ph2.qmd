...
*Ein hoher BMI führt zu erhöhtem systolischen Blutdruck*

Im Modell: *Jemand mit einem hohen BMI hat einen höheren SYSBP*
...
*Diabetes führt zu Gefäßerkrankungen*

Im Modell: *Jemand mit bekannter Diabetes Diagnose hat eine höhere Chance im Beobachtungszeitraum zu versterben*

- `DIABETES`: unabhängige Variable
- `DEATH`: abhängige Variable
...
gf_violin(GLUCOSE ~ CVD, data=fram)
```
